...
class _MaintenanceApi implements MaintenanceApi {
  ...
  Future<MaintenanceStatusResponseDto> getMaintenanceStatus() async {
    ...
    final _options = _setStreamType<MaintenanceStatusResponseDto>(
    ...
    late MaintenanceStatusResponseDto _value;
    try {
      _value = MaintenanceStatusResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
